...
export const ordersApi = {
  ...
  createItem: (orderId, itemData) =>
    api.post(`/orders/${orderId}/items`, itemData),
...
ordersApi.updatePosition = (orderId, position) =>
  api.put(`/orders/${orderId}/position`, { position });
ordersApi.bulkDelete = (orderIds) =>
  api.post("/orders/bulk-delete", { order_ids: orderIds });

// Analytics API
export const analyticsApi = {
  getDashboardStats: () => api.get("/analytics/dashboard"),
  getRegionalBreakdown: (division) =>
    api.get(`/analytics/regions?division=${encodeURIComponent(division)}`),
...
export const settingsApi = {
  ...
  createSteadfastOrder: (orderId) =>
    api.post(`/settings/steadfast/order/${orderId}`),
};
